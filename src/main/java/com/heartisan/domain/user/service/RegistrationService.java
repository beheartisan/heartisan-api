...
public class RegistrationService {
	...
	public User createUser(RegistrationBean regisrationBean) {
		...
		if (isUserAlreadyExists(regisrationBean)) {
	...
	public boolean isUserAlreadyExists(RegistrationBean regisrationBean) {

		return (userRepository.findByUsername(regisrationBean.getUsername()) != null) ? true : false;
